...
Check if num1 is greater than num2, or less than num3. Stores the result of
said comparison in a variable called my_bool.
...
Verifica si num1 es mayor que num2, o menor que num3. Almacena el resultado de
